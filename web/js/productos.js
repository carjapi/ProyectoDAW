const ratones = {
    dedos: [
        ...
        { nombre: "Lamzu Atlantis OG", precio: "109,90€", imagen: "img/LamzuAtlantis.jpg" }
    ],
    garra: [
    ...
    palma: [
        { nombre: "Fnatic x Lamzu Thorn 4K", precio: "151,77€", imagen: "img/LamzuThorn.jpg" },
        { nombre: "Razer DeathAdder V3 Pro", precio: "129,99€", imagen: "img/RazerDeath.jpg" }
    ],
    polivalentes: [
        { nombre: " Razer Viper V3 Pro", precio: "165,99€", imagen: "img/ViperV3.jpg" },
        { nombre: "Logitech G Pro X Superlight 2", precio: "115,95€", imagen: "img/Gpro2.jpg" }
    ]
};
